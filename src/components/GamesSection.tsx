      ...
      <div className="mx-auto max-w-7xl">
          ...
          {games.map((lineupGame, index) => (
            ...
            >
              <div className={`relative h-64 overflow-hidden ${lineupGame.slug === "sniper" ? "sniper-action-frame" : ""}`}>
                {lineupGame.slug === "sniper" ? (
                  <SniperAnimation className="highlight-game-media h-full w-full" />
        ...
        >
          <div className={`relative min-h-[360px] ${game.slug === "sniper" ? "sniper-action-frame" : ""}`}>
            {game.slug === "sniper" ? (
              <SniperAnimation alt="SNIPER animated key art" className="h-full min-h-[360px] w-full" />
